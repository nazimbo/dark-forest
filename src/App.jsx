  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden font-sans text-gray-200">
      ...
      <div className="relative z-10 w-full h-full flex flex-col pointer-events-none">
        ...
        <div className="flex-1 flex items-end sm:items-center p-4 sm:p-6 md:p-8 lg:p-16">
        ...
        <footer className="p-4 sm:p-6 md:p-8 text-center text-xs text-gray-700 pointer-events-auto">
