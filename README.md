...
- **Multilingual support** — 10 languages (EN, FR, ES, DE, ZH, JA, PT, AR, FA, HE) with RTL support, pluralization, and persistent preference
...
- Node.js `^20.19.0 || >=22.12.0` (required by Vite 7 — older versions fail at install/dev)
- npm or yarn
...
│       └── translations.js         # Translation strings and narrative content (10 languages)
├── .github/
│   └── workflows/
